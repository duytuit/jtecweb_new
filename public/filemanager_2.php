...
define('___url', isset($_GET['file_path'])?'//'.fm_clean_path($_GET['file_path']):'');
...
$__file_path = isset($_GET['file_path'])?'//'.fm_clean_path($_GET['file_path']):'';
// exit('//'.fm_clean_path($_GET['file_path']));
...
if (isset($_GET['view'])) {
    ...
    <div style="margin-top: -110px;">
        <object data="<?php echo convertPdfToBase64($file_path) ?>" width="100%" style="height:100vh" type="application/pdf"></object>
    </div>
    <?php
        fm_show_footer();
    exit;
