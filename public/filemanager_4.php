...
$root_path = "//192.168.207.6/jtecdata/JTEC_PD_PROGAM/CMSWeb/data_laprap";
...
if (isset($_GET['view'])) {
    ...
    <div class="row">
        <div class="col-12">
           ...
           <object data="<?php echo convertPdfToBase64($file_path) ?>" width="102%" style="height:130vh;margin-left: -12px;" type="application/pdf"></object>
           </div>
        </div>
    </div>
    <?php
