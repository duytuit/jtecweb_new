...
class requestFormController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       return view('backend.pages.requestForm.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('backend.pages.requestForm.create');
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            'code' => 'required',
            'name' => 'required|unique:requestForm,name'
        ]);
        try {
            $image = null;
            if (!is_null($request->image)) {
                $image = UploadHelper::upload('image', $request->image, $request->name . '-' . time(), 'public/requestForm/images/asset');
            }
            Asset::create([
                'code'=>$request->code,
                'name'=> $request->name,
            ...
            return redirect()->route('admin.requestForm.index');
        } catch (\Exception $e) {
            return back();
        }
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('backend.pages.requestForm.edit', compact('asset','manager'));
    }
    ...
    {
        $request->validate([
            'name' => 'required|unique:requestForm,name' . ($id ? ",$id" : '')
        ]);
