...
namespace App\Http\Controllers\Backend\Vue;
...
class WareHouseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.pages.warehouses_vue.index');
    }
    public function index_data(Request $request)
    {
        ...
        $_query = Required::with('accessory', 'department', 'signatureSubmission')->where('from_type', ArrayHelper::from_type_rquired_accessory)->whereDate('created_at',Carbon::parse($curentDate)->format('Y-m-d'))->where(function ($query) use ($request) {
        ...
        $page_length = isset($request['page_length']) ? $request['page_length'] : 5;
        $data['lists'] = $_query->paginate($page_length);
