...
class DynamicColumnController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       return view('backend.pages.dynamicColumn.index',$data);
    }
    ...
    public function create()
    {
        ...
        return view('backend.pages.dynamicColumn.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (!is_null($request->image)) {
                $image = UploadHelper::upload('image', $request->image, $request->name . '-' . time(), 'public/questions/images/asset');
            }
            Asset::create([
                'code'=>$request->code,
                'name'=> $request->name,
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('backend.pages.dynamicColumn.edit', compact('asset','manager'));
    }
    ...
    {
        $request->validate([
            'name' => 'required|unique:questions,name' . ($id ? ",$id" : '')
        ]);
