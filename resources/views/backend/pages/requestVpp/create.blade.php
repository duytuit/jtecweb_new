                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-6">
                                        <label class="control-label" for="searchcode">SCAN CODE<span class="required">*</span></label>
                                        ...
                                        <label class="control-label" for="searchcode">Mã vật phẩm:</label>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-control" name="type" id="order_type" style="font-weight: bold">
                                            <option value="6">Yêu Cầu Văn Phòng Phẩm</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row form-group">
...
@section('scripts')
    <script>
      ...
      function filterAccessorys(){
        ...
        if(selectedValue){
            $.ajax({
                url: "{{ route('admin.requestVpps.ajaxSuggestions') }}",
                type: "POST",
                dataType: "json",
                data: {
