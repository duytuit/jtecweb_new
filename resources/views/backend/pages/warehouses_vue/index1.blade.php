...
@section('admin-content')
    ...
    <div class="container-fluid">
        ...
        <form id="form-search-advance" action="{{ route('admin.warehouses.report') }}" method="get" class="hidden">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-2">
                        <select class="form-control" name="type" id="order_type"  onchange="this.form.submit()">
                            ...
                            <option value="113" {{ @$filter['type'] === '113' ? 'selected' : '' }}>Yêu Cầu</option>
                        </select>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-1">
                        <a href="{{ route('admin.warehouses.exportExcelReport',Request::all()) }}" class="btn btn-success">Excel</a>
                    </div>
                </div>
            </div>
        </form>
                                        ...
                                        <div class="information-export">
                                            <div style="display: flex;gap: 0.2em;justify-content: center;">
                                                ...
                                                <div style="width: 100%;display: grid;">
                                                    @if ($item->status == 0)
                                                        <div class="btn btn-sm btn btn-danger">Chưa xuất</div>
                                                    @else
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_post" class="form-horizontal" role="form" method="POST" action="{{ route('admin.warehouses.complete') }}">
