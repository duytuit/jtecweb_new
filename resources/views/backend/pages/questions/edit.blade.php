...
@section('admin-content')
  ...
  <div class="container-fluid">
        ...
        <div class="create-page">
            <form action="{{ route('admin.questions.update', ['id' => $question->id]) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="form-body">
                    ...
                    @endif
                    <div class="card-body">
                        <input type="hidden" name="assetId" id="assetId" value="{{ $question->id }}">
                        <div class="col-6 align-items-center justify-content-center mx-auto">
                            <div class="w-100">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        ...
                                        value="{{ $question->code }}" placeholder="" required="">
                                </div>
                            </div>
                            <div class="w-100">
                                <div class="form-group">
                                    ...
                                    <input type="text" data-parsley-required-message="Tên bài thi online là bắt buộc"
                                        class="form-control" id="name" name="name" value="{{ $question->name }}"
                            ...
                            <div class="w-100">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="model" name="model" value="{{ $question->model }}" placeholder="Hãng sản xuất">
                                </div>
                            </div>
                            <div class="w-100">
                                <div class="form-group">
                                    <label class="control-label" for="color">Màu sắc</label>
                                    <input type="text" class="form-control" id="color" name="color" value="{{ $question->color }}" placeholder="Màu sắc">
                                </div>
                            </div>
                            <div class="w-100">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control dropify" data-height="100"
                                        data-allowed-file-extensions="png jpg jpeg webp" id="image" name="image" data-default-file="{{ $question->image != null ? asset('public/questions/images/asset/' . $question->image) : null }}" />
                                </div>
                            </div>
                            <div class="w-100">
                                <div class="form-group">
                            ...
                            <div class="w-100">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="note" value="{{ $question->note }}" />
                                </div>
                            </div>
                            <div class="w-100">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" id="_status" name="status"
                                        value="1" {{ $question->status ? 'checked' : '' }} class="d-none" />
