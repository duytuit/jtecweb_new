...
@section('title')
    @include('backend.pages.assembles.partials.title')
@endsection

@section('admin-content')
  @include('backend.pages.assembles.partials.header-breadcrumbs')
  <div class="container-fluid">
        @include('backend.layouts.partials.messages')
        <div class="create-page">
            <form action="{{ route('admin.assembles.update', ['id' => $asset->id]) }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="w-100">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control dropify" data-height="100"
                                        data-allowed-file-extensions="png jpg jpeg webp" id="image" name="image" data-default-file="{{ $asset->image != null ? asset('public/assembles/images/asset/' . $asset->image) : null }}" />
                                </div>
                            </div>
                            <div class="w-100">
                                <div class="form-group">
                            ...
                            <div class="row fixed-bottom">
                                <div class="col-md-6 form-actions mx-auto">
                                    <button type="submit" class="btn btn-success"> <i class="fa fa-check"></i>
                                        Lưu</button>
                                    <a href="{{ route('admin.assembles.index') }}" class="btn btn-dark">Quay lại</a>
                                </div>
                            </div>
                        </div>
                    </div>
