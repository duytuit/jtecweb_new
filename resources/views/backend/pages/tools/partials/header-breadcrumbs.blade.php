        ...
        <div class="col-5 align-self-center">
            <h4 class="page-title">
                ...
                @elseif(Route::is('admin.assets.edit'))
                    Sửa công cụ <span class="badge badge-info">{{ $asset->title }}</span>
                @elseif(Route::is('admin.assets.show'))
                    Chi tiết công cụ <span class="badge badge-info">{{ $asset->title }}</span>
            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        @elseif(Route::is('admin.assets.edit'))
                            <li class="breadcrumb-item"><a href="{{ route('admin.assets.index') }}">Danh sách</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Sửa công cụ</li>
                        @elseif(Route::is('admin.assets.show'))
                            <li class="breadcrumb-item"><a href="{{ route('admin.assets.index') }}">Danh sách</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Chi tiết công cụ</li>
                        @endif
