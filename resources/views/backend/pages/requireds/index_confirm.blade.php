...
@section('admin-content')
    ...
    <div class="container-fluid">
        ...
        <form id="form-search-advance" action="{{ route('admin.requireds.indexConfirm') }}" method="get" class="hidden">
                    ...
                    <div class="col-sm-1">
                        <span class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="btn-action" data-target="#form_lists" data-method="confirm_fromdept" href="javascript:;"><i class="fa fa-check" style="color: green;"></i> Duyệt</a></li>
                                <li><a class="btn-action" data-target="#form_lists" data-method="unconfirm_fromdept" href="javascript:;"><i class="fa fa-times"></i> Bỏ duyệt</a></li>
                            </ul>
                        </span>
                    </div>
                    <div class="col-sm-2">
