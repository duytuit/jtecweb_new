...
@section('admin-content')
    ...
    <div class="container-fluid">
        ...
        <form id="form-search-advance" action="{{ route('admin.warehouses.index') }}" method="get" class="hidden">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group mb-3">
                            ...
                            value="{{ @$filter['search_date'] }}" placeholder="Ngày yêu cầu" autocomplete="off" onchange="this.form.submit()">
