                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('public/assets/images/cutedps/'.$required->image) }}" alt="Image" class="img width-100" />
                                    @else
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-actions">
                                    <div class="card-body">
                                        <a  class="btn btn-success" href="{{ route('admin.cutedps.edit', $required->id) }}"> <i class="fa fa-edit"></i> Edit Now</a>
                                        <a href="{{ route('admin.cutedps.index') }}" class="btn btn-dark ml-2">Hủy</a>
                                    </div>
                                </div>
                            </div>
                        </div>
