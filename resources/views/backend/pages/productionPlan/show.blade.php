                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('public/productionPlans/images/requireds/'.$required->image) }}" alt="Image" class="img width-100" />
                                    @else
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-actions">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('admin.requireds.index') }}" class="btn btn-dark ml-2">Hủy</a>
                                    </div>
                                </div>
                            </div>
                        </div>
