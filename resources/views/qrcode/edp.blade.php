                ...
                <td colspan="2" width="35%">
                    ...
                    <div style="display: flex">
                        ...
                        <div class="content_text">
                            ...
                            <div style="font-size: 11px">{{$confirm_form->edp->infomeia1 != " " ? $confirm_form->edp->infomeia1 : '-'}}{{$confirm_form->edp->infomeia2 != " " ? $confirm_form->edp->infomeia2 : '-'}}</div>
                        </div>
                    </div>
                </td>
                <td colspan="2" width="35%">
                    ...
                    <div style="display: flex">
                        ...
                        <div class="content_text">
                            ...
                            <div style="font-size: 11px">{{$confirm_form->edp->infomeib1 != " " ? $confirm_form->edp->infomeib1 : '-'}}{{$confirm_form->edp->infomeib2 != " " ? $confirm_form->edp->infomeib2 : '-'}}</div>
                        </div>
                    </div>
                </td>
            </tr>
